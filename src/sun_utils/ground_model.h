...
namespace SUN {
    namespace utils {
        ...
        public:
            ...
            virtual Eigen::Vector3d ProjectPointToGround(const Eigen::Vector3d &p) const=0; // Compute projection of 3d
            // point to ground
            ...
            virtual Eigen::Vector3d Normal(const Eigen::Vector3d &point_3d) const=0; // Returns normal at the specified
            // 3d (ground) point
