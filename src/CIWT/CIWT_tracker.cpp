...
// tracking
#include "../../include/tracking/qpbo.h"
...
namespace GOT {
    namespace tracking {
        namespace ciwt_tracker {
            ...
            Eigen::VectorXi RunInference(const std::vector<Hypothesis> &hypos, int current_frame
                    , UnaryFunc unary_pot, PairwiseFunc pairwise_pot, const po::variables_map &parameter_map) {
