...
#include "../../include/libviso2/viso_stereo.h"
...
namespace libviso2 {
    ...
    VisualOdometryStereo::updateParameters(vector<Matcher::p_match> &p_matched, vector<int32_t> &active, vector<double> &tr, double step_size, double eps) {
