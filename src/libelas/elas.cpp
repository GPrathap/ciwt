...
#include "../../include/libelas/elas.h"

#include <math.h>
#include "../../include/libelas/descriptor.h"
#include "../../include/libelas/triangle.h"
#include "../../include/libelas/matrix.h"

using namespace std;

namespace libelas {

void Elas::process (uint8_t* I1_,uint8_t* I2_,float* D1,float* D2,const int32_t* dims, vector<support_pt> &support_points){
