...
#include "../../include/scene_segmentation/ground_histogram.h"
...
namespace GOT {
    namespace segmentation {
        ...
        void GroundHistogram::ComputeDensityMap(pcl::PointCloud<pcl::PointXYZRGBA>::ConstPtr input_cloud,
                const SUN::utils::Camera &camera, bool distance_compensate,
                /*bool is_organized_cloud,*/ const double normalization_factor, const double threshold) {
