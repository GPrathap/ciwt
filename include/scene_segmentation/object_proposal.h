...
namespace GOT {
    namespace segmentation {
        ...
        /**
           * @brief This class represents one object proposal. Object proposal is 3D region, mostly defined by set of 3d points.
           * These 3d points are stored here as
           *        (linear) indices, corresponding to 'cells' of (organized) pcl::PointCloud. Thus, indices relate the region to both,
           *        2d image plane and a set of 3d points.
        ...
        public:
            ...
            void init(const std::vector<int> &groundplane_indices, const std::vector<int> &pointcloud_indices
                    , const Eigen::Vector4d &bounding_box_2d, const Eigen::VectorXd &bounding_box_3d,  int proposal_id
                    , double score);
        ...
        private:
            ...
            Eigen::VectorXd bounding_box_3d_; // 3D bounding box: [centroid_x centroid_y centroid_z width height length
            // q.w q.x q.y q.z]
